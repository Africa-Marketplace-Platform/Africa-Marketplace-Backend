...
exports.createProduct = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    const { name, description, price, business, stock, category, tags, discount, dynamicPrice, flashSale, saleEndTime, variants, attributes, seo } = req.body;
    let images = [];
...
exports.updateProduct = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    const { name, description, price, stock, category, tags, discount, dynamicPrice, flashSale, saleEndTime, variants, attributes, seo } = req.body;
