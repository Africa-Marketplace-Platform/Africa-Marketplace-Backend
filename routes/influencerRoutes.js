...
const { createInfluencer, getInfluencerById, updateInfluencer, deleteInfluencer, searchInfluencers, contactInfluencer, manageCollaboration, rateInfluencer } = require('../controllers/influencerController');
